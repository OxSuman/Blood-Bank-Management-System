...
/*create table fund_info in which your site contact information is stored.*/
create table fund_donation(
fund_id int auto_increment Not Null,
fdonor_name varchar(50) NOT NULL,
t_id varchar(50) NOT NULL,
fdonor_mail varchar(50) NOT NULL,
primary key(fund_id)
);
